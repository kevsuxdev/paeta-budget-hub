...
<div class="p-6">
    <h1 class="text-3xl font-bold text-main">Budget Archive</h1>
    <p class="text-main font-medium mb-6">View and manage archived budget documents (approved and rejected).</p>
            ...
            <div class="bg-orange-brown rounded-lg p-6 border border-primary overflow-hidden shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white">{{ $totalArchived }}</p>
            ...
            <div class="bg-orange-brown rounded-lg p-6 border border-primary overflow-hidden shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white">{{ $approvedBudgets }}</p>
            ...
            <div class="bg-orange-brown rounded-lg p-6 border border-primary overflow-hidden shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white">{{ $formattedTotalValue }}</p>
            ...
            <div class="bg-orange-brown rounded-lg p-6 border border-primary overflow-hidden shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white">{{ $totalDepartments }}</p>
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <form action="{{ route('admin.archive') }}" method="GET" class="flex flex-col md:flex-row gap-2">
                    ...
                    <div class="relative">
                        ...
                        <svg class="absolute left-3 top-2.5 h-5 w-5 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <select
                        name="status"
                        class="px-4 py-2 text-sm bg-primary/50 border border-gray-600 rounded-lg text-white"
                    >
                    ...
                    @forelse($budgets as $budget)
                        <tr class="hover:bg-primary/20 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                                <button
                                    class="btn-view-budget px-3 py-1 border border-black text-sm text-white bg-primary rounded hover:bg-primary/80 font-medium"
                                ...
                                <a
                                    ...
                                    class="px-3 py-1 border border-black text-sm text-white bg-secondary rounded hover:bg-secondary/80 font-medium"
                                    target="_blank"
                                >
                                    Download PDF
                                </a>
                                ...
                                @if($budget->supporting_document)
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        class="px-3 py-1 border border-black text-sm text-black bg-input rounded hover:bg-input/80 font-medium"
                                    >
                                        Document
                                    </a>
                                @endif
