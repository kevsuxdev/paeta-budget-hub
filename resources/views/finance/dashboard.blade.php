...
<div class="p-6 space-y-6">
    <div class="w-full flex items-center justify-between">
        <h1 class="text-2xl font-bold text-main">Finance Dashboard</h1>
        <div class="relative">
    ...
    <article class="space-y-2">
        <p p class="text-main text-xl font-medium">Welcome, {{ $user->full_name }}!</p>
        <p class="text-sm font-medium text-white bg-orange-brown p-2 rounded-xl w-fit px-4 border border-primary overflow-hidden shadow-sm">Finance Department</p>
    </article>
            ...
            <div class="bg-orange-brown rounded-lg p-6 shadow-lg border border-primary overflow-hidden">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white">{{ $pendingReview }}</p>
                    </div>
                    <div class="bg-primary/50 rounded-full p-3">
                        <svg class="w-8 h-8 text-orange-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-orange-brown rounded-lg p-6 shadow-lg border border-primary overflow-hidden">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white">{{ $approvedCount ?? '-' }}</p>
                    </div>
                    <div class="bg-primary/50 rounded-full p-3">
                        <svg class="w-8 h-8 text-orange-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-orange-brown rounded-lg p-6 shadow-lg border border-primary overflow-hidden">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white">{{ $rejectedCount ?? '-' }}</p>
                    </div>
                    <div class="bg-primary/50 rounded-full p-3">
                        <svg class="w-8 h-8 text-orange-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="flex items-start w-full gap-2">
        ...
        <div class="bg-orange-brown rounded-lg shadow-lg p-6 w-full border border-primary overflow-hidden">
        ...
        <!-- Quick Actions -->
        <div class="bg-orange-brown p-6 col-span-1 rounded-lg text-nowrap shadow-sm border border-primary  ">
            <h3 class="text-lg font-semibold text-white mb-4">Quick Actions</h3>
            <div class="space-y-3">
                <a href="{{ route('finance.review') }}" class="flex items-center px-4 py-3 bg-secondary text-white rounded-lg hover:bg-opacity-90 transition-colors">
