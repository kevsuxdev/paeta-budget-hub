...
<div class="p-6 space-y-6">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="text-sm text-white font-medium">
                                        ...
                                        @if($notification->action === 'password_changed')
                                            <span class="ml-1">Password Changed</span>
                                        @else
    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <!-- Budget Submission -->
            <a href="{{ route('staff.budget.create') }}" class="bg-orange-brown hover:bg-primary transition-colors rounded-lg p-6 shadow-lg flex items-center space-x-4 border border-primary overflow-hidden">
            ...
            <!-- Document Tracking -->
            <a href="{{ route('staff.document.tracking') }}" class="bg-orange-brown hover:bg-primary transition-colors rounded-lg p-6 shadow-lg flex items-center space-x-4 border border-primary overflow-hidden">
                <div class="bg-primary/50 rounded-full p-4">
                    <svg class="w-10 h-10 text-orange-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
