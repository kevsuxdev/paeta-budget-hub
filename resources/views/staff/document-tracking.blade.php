...
<div class="p-6">
    <h1 class="text-2xl font-bold text-main">Document Tracking</h1>
    <p class="text-main font-medium mb-6">Track budget requests from your department with search and filter capabilities.</p>
    <!-- Alert Messages -->
    @if(session('success'))
                ...
                <tbody class="bg-orange-brown divide-y divide-primary">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <button
                                class="btn-view-budget bg-primary text-white px-4 py-2 rounded-md cursor-pointer font-medium hover:bg-secondary"
                            ...
                            <a href="{{ route('staff.budget.edit', $budget->id) }}" class="ml-2 inline-block bg-input text-black px-3 py-2 rounded-md hover:bg-input/80 text-sm">Edit</a>
                            @endif
